        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-md-6 form-box">
                    ...
                    @if(!auth()->check())
                    <form role="form" action="{{ route('zakat.transaction.create.withoutLogin', $program->program_id) }}" method="post" class="f1">
                    ...
                    <div class="f1">
                        ...
                        <form action="{{ route('zakat.transaction.create', $program->program_id) }}" method="POST">
                            {{ csrf_field() }}
                            <div class="custom-control custom-checkbox mr-sm-2">
                                <input type="checkbox" name="hide_credential" value=1 class="custom-control-input" id="customControlAutosizing">
                                <label class="custom-control-label" for="customControlAutosizing">Jangan tampilkan nama
                            ...
                            <div class="f1-buttons mt-5">
                                <a href="" class="btn btn-previous bg-dark">Previous</a>
                                <button type="submit" class="btn btn-next">Next</button>
                            </div>
                        </form>
                    </div>
